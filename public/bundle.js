...
galeria$3.querySelector(".galeria__carousel-slide--active").classList.remove("galeria__carousel-slide--active");
      //Marcamos la imagen del carousel como active.
